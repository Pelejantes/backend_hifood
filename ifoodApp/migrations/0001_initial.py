# Generated by Django 3.2.5 on 2024-05-12 13:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataPedido', models.DateField(default=datetime.datetime(2024, 5, 12, 10, 51, 12, 520643))),
                ('gorjeta', models.SmallIntegerField(null=True)),
                ('cupomld', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ifoodApp.cupom')),
                ('formaPagld', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ifoodApp.formapag')),
