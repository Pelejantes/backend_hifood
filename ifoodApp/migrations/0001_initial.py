# Generated by Django 3.2.5 on 2024-03-19 15:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordenadas', models.CharField(default=True, max_length=20, null=True)),
        ...
        migrations.AddField(
            model_name='usuario',
            name='codVerifId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ifoodApp.codverif'),
        ),
        migrations.AddField(
            model_name='usuario',
