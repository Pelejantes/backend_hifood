...
BEGIN
    FOR i IN 1..50 LOOP
        ...
        INSERT INTO Estabelecimento (   nomeEstab, telefoneEstab, imagemEstab, cnpj, emailEstab)
        VALUES (  'Estabelecimento_' || i, telefone_gerado, NULL, cnpj_gerado, 'estabelecimento_' || i || '@restaurante.com.br');
    END LOOP;
END $$;
