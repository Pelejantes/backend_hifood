...
from .models import Usuario, Endereco, EnderecoEntrega, CodVerif, TipoUsuario, Estabelecimento, Cupom, CuponsUsuario, Categoria, Produto, Pedido, ItemPedido, FormaPag, Cartao
