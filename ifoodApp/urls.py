...
from .views import inicio_view, usuario_view, endereco_view, enderecoEntrega_view, login_view, tipoUsuario_view, codVerif_view, estabelecimento_view, cupom_view, categoria_view, produto_view, cuponsUsuario_view, pedido_view, itemPedido_view, formaPagamento_view, cartao_view, pagamento_view
...
urlpatterns = [
     ...
     path("enderecos/usuario/<str:pk>",
          endereco_view.exibir_enderecosUsuario_view),
     ...
     path("enderecos/usuario/criar/<str:pk>",
          endereco_view.criar_enderecoUsuario_view),
